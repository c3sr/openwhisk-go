...
func (o *UpdateRuleParams) WithRule(rule *swagger_models.RulePut) *UpdateRuleParams {
	o.SetRule(rule)
	return o
}

// SetRule adds the rule to the update rule params
func (o *UpdateRuleParams) SetRule(rule *swagger_models.RulePut) {
	o.Rule = rule
}
...
func (o *UpdateRuleParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Rule == nil {
		o.Rule = new(swagger_models.RulePut)
	}
