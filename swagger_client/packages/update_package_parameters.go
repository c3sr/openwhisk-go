...
type UpdatePackageParams struct {
	...
	*/
	Package *swagger_models.PackagePut
	/*PackageName
	  Name of package
...
func (o *UpdatePackageParams) WithPackage(packageVar *swagger_models.PackagePut) *UpdatePackageParams {
	o.SetPackage(packageVar)
	return o
}

// SetPackage adds the package to the update package params
func (o *UpdatePackageParams) SetPackage(packageVar *swagger_models.PackagePut) {
...
func (o *UpdatePackageParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Package == nil {
		o.Package = new(swagger_models.PackagePut)
	}
