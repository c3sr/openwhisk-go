...
type GetAllEntitiesInNamespaceOKBody struct {
	...
	// actions
	// Required: true
	Actions []*swagger_models.EntityBrief `json:"actions"`

	// packages
	// Required: true
	Packages []*swagger_models.EntityBrief `json:"packages"`

	// rules
	// Required: true
	Rules []*swagger_models.EntityBrief `json:"rules"`

	// triggers
	// Required: true
	Triggers []*swagger_models.EntityBrief `json:"triggers"`
}
