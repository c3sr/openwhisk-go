...
type UpdateActionParams struct {
	...
	*/
	Action *swagger_models.ActionPut
	/*ActionName
	  Name of action
...
func (o *UpdateActionParams) WithAction(action *swagger_models.ActionPut) *UpdateActionParams {
	o.SetAction(action)
	return o
}

// SetAction adds the action to the update action params
func (o *UpdateActionParams) SetAction(action *swagger_models.ActionPut) {
	o.Action = action
}
...
func (o *UpdateActionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Action == nil {
		o.Action = new(swagger_models.ActionPut)
	}
