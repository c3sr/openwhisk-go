...
func (o *UpdateTriggerParams) WithTrigger(trigger *models.TriggerPut) *UpdateTriggerParams {
	o.SetTrigger(trigger)
	return o
}

// SetTrigger adds the trigger to the update trigger params
func (o *UpdateTriggerParams) SetTrigger(trigger *models.TriggerPut) {
	o.Trigger = trigger
}
...
func (o *UpdateTriggerParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Trigger == nil {
		o.Trigger = new(models.TriggerPut)
	}
